...
from common.decos import try_except_wrapper
from common.descriptor import Port
from common.meta import ServerVerifier
from common.utils import *
from common.variables import *
from db.server_db import ServerStorage
from gui.server_gui import (ConfigWindow, HistoryWindow, MainWindow,
...
def main():
    ...
    database = ServerStorage(
        create_sqlite_uri(os.path.join(config["SETTINGS"]["database_path"], config["SETTINGS"]["database_file"]), 'server')
    )
